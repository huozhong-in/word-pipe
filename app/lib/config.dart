...
final String SSE_SERVER_HOST =
    kDebugMode ? "http://192.168.0.166" : "https://wordpipe.in";
...
final String HTTP_SERVER_HOST =
    kDebugMode ? "http://192.168.0.166/api" : "https://wordpipe.in/api";

final AVATAR_FILE_DIR = "avatar";
final VOICE_FILE_DIR = "voice";
...
final ThemeData appThemeDark = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      bodyLarge:
          TextStyle(fontSize: 14.0, fontFamily: "Roboto", fontFamilyFallback: [
        "PingFang SC",
        "Heiti SC",
      ]),
      bodyMedium:
          TextStyle(fontSize: 12.0, fontFamily: "Roboto", fontFamilyFallback: [
        "PingFang SC",
        "Heiti SC",
      ]),
      bodySmall:
          TextStyle(fontSize: 10.0, fontFamily: "Roboto", fontFamilyFallback: [
        "PingFang SC",
        "Heiti SC",
      ]),
...
final ThemeData appThemeBright = ThemeData(
    ...
    textTheme: TextTheme(
      displayLarge: TextStyle(
          ...
          color: Color.fromARGB(255, 31, 165, 69)),
      displayMedium: TextStyle(
          fontSize: 48,
          fontWeight: FontWeight.bold,
          color: Color.fromARGB(255, 24, 198, 56)),
      ...
      headlineSmall: TextStyle(
          fontSize: 12.0,
          fontWeight: FontWeight.bold,
          color: Color.fromARGB(255, 3, 103, 16)),
    ),
...
class CustomColors {
  ...
  static const Color splashEnd =
      Color.fromARGB(255, 31, 165, 69); //Color.fromARGB(255, 24, 198, 56);
...
String decrypt(String encryptedString) {
  ...
  BlockCipher cipher = AESEngine()
    ..init(
        false, KeyParameter(Uint8List.fromList("0123456789abcdef".codeUnits)));
